...
mv pulse-agent-plugins pulse-agent-plugins-1.7
tar czvf pulse-agent-plugins-1.7.tar.gz pulse-agent-plugins-1.7
...
mv pulse-xmpp-agent-%version.tar.gz %{buildroot}/var/lib/pulse2/clients/
	...
	# We create pulse-agent-plugins tarball
        mv pulse-agent-plugins-1.7.tar.gz %{buildroot}/var/lib/pulse2/clients
	...
	cp scripts_installer/generate-kiosk-package %{buildroot}/var/lib/pulse2/clients/win32
