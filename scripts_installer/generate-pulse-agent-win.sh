...
update_nsi_script_full() {
	...
	INSTALL_FULL_PY_WIN32='StrCpy $0 `pip install --upgrade --no-index --find-links="$INSTDIR\tmp" ${PY_WIN32}`'
	INSTALL_FULL_PY_NETIFACES='StrCpy $0 `pip install --upgrade --no-index --find-links="$INSTDIR\tmp" ${PY_NETIFACES}`'
	INSTALL_FULL_PY_COMTYPES='StrCpy $0 `pip install --upgrade --no-index --find-links="$INSTDIR\tmp" ${PY_COMTYPES}`'
	INSTALL_FULL_PY_CONFIGPARSER='StrCpy $0 `pip install --upgrade --pre --no-index --find-links="$INSTDIR\tmp" ${PY_CONFIGPARSER}`'
	INSTALL_FULL_PY_UTILS='StrCpy $0 `pip install --upgrade --no-index --find-links="$INSTDIR\tmp" ${PY_UTILS}`'
	INSTALL_FULL_PY_SLEEKXMPP='StrCpy $0 `pip install --upgrade --no-index --find-links="$INSTDIR\tmp" ${PY_SLEEKXMPP}`'
	INSTALL_FULL_PY_WMI='StrCpy $0 `pip install --upgrade --no-index --find-links="$INSTDIR\tmp" ${PY_WMI}`'
	INSTALL_FULL_PY_ZIPFILE='StrCpy $0 `pip install --upgrade --no-index --find-links="$INSTDIR\tmp" ${PY_ZIPFILE}`'
	INSTALL_FULL_PY_CURL='StrCpy $0 `pip install --upgrade --no-index --find-links="$INSTDIR\tmp" ${PY_CURL}`'
	INSTALL_FULL_PY_LXML='StrCpy $0 `pip install --upgrade --no-index --find-links="$INSTDIR\tmp" ${PY_LXML}`'
	INSTALL_FULL_PY_CRYPTO='StrCpy $0 `pip install --upgrade --no-index --find-links="$INSTDIR\tmp" ${PY_CRYPTO}`'
	INSTALL_FULL_PY_CRON='StrCpy $0 `pip install --upgrade --no-index --find-links="$INSTDIR\tmp" ${PY_CRON}`'
	INSTALL_FULL_PY_PSUTIL='StrCpy $0 `pip install --upgrade --no-index --find-links="$INSTDIR\tmp" ${PY_PSUTIL}`'
...
update_nsi_script_dl() {
	...
	INSTALL_DL_PY_WIN32='StrCpy $0 `pip install --upgrade --no-index --find-links="$INSTDIR\tmp" ${PY_WIN32}`'
	INSTALL_DL_PY_NETIFACES='StrCpy $0 `pip install --upgrade ${PY_NETIFACES}`'
	INSTALL_DL_PY_COMTYPES='StrCpy $0 `pip install --upgrade ${PY_COMTYPES}`'
	INSTALL_DL_PY_CONFIGPARSER='StrCpy $0 `pip install --upgrade --pre ${PY_CONFIGPARSER}`'
	INSTALL_DL_PY_UTILS='StrCpy $0 `pip install --upgrade ${PY_UTILS}`'
	INSTALL_DL_PY_SLEEKXMPP='StrCpy $0 `pip install --upgrade ${PY_SLEEKXMPP}`'
	INSTALL_DL_PY_WMI='StrCpy $0 `pip install --upgrade ${PY_WMI}`'
	INSTALL_DL_PY_ZIPFILE='StrCpy $0 `pip install --upgrade ${PY_ZIPFILE}`'
	INSTALL_DL_PY_CURL='StrCpy $0 `pip install --upgrade --no-index --find-links="$INSTDIR\tmp" ${PY_CURL}`'
	INSTALL_DL_PY_LXML='StrCpy $0 `pip install --upgrade --no-index --find-links="$INSTDIR\tmp" ${PY_LXML}`'
	INSTALL_DL_PY_CRYPTO='StrCpy $0 `pip install --upgrade --no-index --find-links="$INSTDIR\tmp" ${PY_CRYPTO}`'
	INSTALL_DL_PY_CRON='StrCpy $0 `pip install --upgrade --no-index --find-links="$INSTDIR\tmp" ${PY_CRON}`'
	INSTALL_DL_PY_PSUTIL='StrCpy $0 `pip install --upgrade --no-index --find-links="$INSTDIR\tmp" ${PY_PSUTIL}`'
